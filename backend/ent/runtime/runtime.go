...
func init() {
	...
	userDescRateLimit5h := userFields[21].Descriptor()
	...
	userDescRateLimit7d := userFields[22].Descriptor()
	...
	userDescUsage5h := userFields[23].Descriptor()
	...
	userDescUsage7d := userFields[24].Descriptor()
