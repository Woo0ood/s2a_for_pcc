...
import (
	...
	"github.com/Woo0ood/sub2api/ent/account"
	...
	"github.com/Woo0ood/sub2api/ent/channelmonitordailyrollup"
	...
	"github.com/Woo0ood/sub2api/ent/idempotencyrecord"
	...
	"github.com/Woo0ood/sub2api/ent/schema"
...
func init() {
	...
	payloadauditlogMixin := schema.PayloadAuditLog{}.Mixin()
	payloadauditlogMixinFields0 := payloadauditlogMixin[0].Fields()
	_ = payloadauditlogMixinFields0
	payloadauditlogFields := schema.PayloadAuditLog{}.Fields()
	_ = payloadauditlogFields
	// payloadauditlogDescCreatedAt is the schema descriptor for created_at field.
	payloadauditlogDescCreatedAt := payloadauditlogMixinFields0[0].Descriptor()
	// payloadauditlog.DefaultCreatedAt holds the default value on creation for the created_at field.
	payloadauditlog.DefaultCreatedAt = payloadauditlogDescCreatedAt.Default.(func() time.Time)
	// payloadauditlogDescUpdatedAt is the schema descriptor for updated_at field.
	payloadauditlogDescUpdatedAt := payloadauditlogMixinFields0[1].Descriptor()
	// payloadauditlog.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	payloadauditlog.DefaultUpdatedAt = payloadauditlogDescUpdatedAt.Default.(func() time.Time)
	// payloadauditlog.UpdateDefaultUpdatedAt holds the default value on update for the updated_at field.
	payloadauditlog.UpdateDefaultUpdatedAt = payloadauditlogDescUpdatedAt.UpdateDefault.(func() time.Time)
	// payloadauditlogDescRequestID is the schema descriptor for request_id field.
	payloadauditlogDescRequestID := payloadauditlogFields[0].Descriptor()
	// payloadauditlog.DefaultRequestID holds the default value on creation for the request_id field.
	payloadauditlog.DefaultRequestID = payloadauditlogDescRequestID.Default.(string)
	// payloadauditlog.RequestIDValidator is a validator for the "request_id" field. It is called by the builders before save.
	payloadauditlog.RequestIDValidator = payloadauditlogDescRequestID.Validators[0].(func(string) error)
	// payloadauditlogDescUserEmail is the schema descriptor for user_email field.
	payloadauditlogDescUserEmail := payloadauditlogFields[2].Descriptor()
	// payloadauditlog.DefaultUserEmail holds the default value on creation for the user_email field.
	payloadauditlog.DefaultUserEmail = payloadauditlogDescUserEmail.Default.(string)
	// payloadauditlog.UserEmailValidator is a validator for the "user_email" field. It is called by the builders before save.
	payloadauditlog.UserEmailValidator = payloadauditlogDescUserEmail.Validators[0].(func(string) error)
	// payloadauditlogDescAPIKeyName is the schema descriptor for api_key_name field.
	payloadauditlogDescAPIKeyName := payloadauditlogFields[4].Descriptor()
	// payloadauditlog.DefaultAPIKeyName holds the default value on creation for the api_key_name field.
	payloadauditlog.DefaultAPIKeyName = payloadauditlogDescAPIKeyName.Default.(string)
	// payloadauditlog.APIKeyNameValidator is a validator for the "api_key_name" field. It is called by the builders before save.
	payloadauditlog.APIKeyNameValidator = payloadauditlogDescAPIKeyName.Validators[0].(func(string) error)
	// payloadauditlogDescGroupName is the schema descriptor for group_name field.
	payloadauditlogDescGroupName := payloadauditlogFields[6].Descriptor()
	// payloadauditlog.DefaultGroupName holds the default value on creation for the group_name field.
	payloadauditlog.DefaultGroupName = payloadauditlogDescGroupName.Default.(string)
	// payloadauditlog.GroupNameValidator is a validator for the "group_name" field. It is called by the builders before save.
	payloadauditlog.GroupNameValidator = payloadauditlogDescGroupName.Validators[0].(func(string) error)
	// payloadauditlogDescClientIP is the schema descriptor for client_ip field.
	payloadauditlogDescClientIP := payloadauditlogFields[7].Descriptor()
	// payloadauditlog.DefaultClientIP holds the default value on creation for the client_ip field.
	payloadauditlog.DefaultClientIP = payloadauditlogDescClientIP.Default.(string)
	// payloadauditlog.ClientIPValidator is a validator for the "client_ip" field. It is called by the builders before save.
	payloadauditlog.ClientIPValidator = payloadauditlogDescClientIP.Validators[0].(func(string) error)
	// payloadauditlogDescEndpoint is the schema descriptor for endpoint field.
	payloadauditlogDescEndpoint := payloadauditlogFields[8].Descriptor()
	// payloadauditlog.DefaultEndpoint holds the default value on creation for the endpoint field.
	payloadauditlog.DefaultEndpoint = payloadauditlogDescEndpoint.Default.(string)
	// payloadauditlog.EndpointValidator is a validator for the "endpoint" field. It is called by the builders before save.
	payloadauditlog.EndpointValidator = payloadauditlogDescEndpoint.Validators[0].(func(string) error)
	// payloadauditlogDescProvider is the schema descriptor for provider field.
	payloadauditlogDescProvider := payloadauditlogFields[9].Descriptor()
	// payloadauditlog.DefaultProvider holds the default value on creation for the provider field.
	payloadauditlog.DefaultProvider = payloadauditlogDescProvider.Default.(string)
	// payloadauditlog.ProviderValidator is a validator for the "provider" field. It is called by the builders before save.
	payloadauditlog.ProviderValidator = payloadauditlogDescProvider.Validators[0].(func(string) error)
	// payloadauditlogDescModel is the schema descriptor for model field.
	payloadauditlogDescModel := payloadauditlogFields[10].Descriptor()
	// payloadauditlog.DefaultModel holds the default value on creation for the model field.
	payloadauditlog.DefaultModel = payloadauditlogDescModel.Default.(string)
	// payloadauditlog.ModelValidator is a validator for the "model" field. It is called by the builders before save.
	payloadauditlog.ModelValidator = payloadauditlogDescModel.Validators[0].(func(string) error)
	// payloadauditlogDescUpstreamModel is the schema descriptor for upstream_model field.
	payloadauditlogDescUpstreamModel := payloadauditlogFields[11].Descriptor()
	// payloadauditlog.DefaultUpstreamModel holds the default value on creation for the upstream_model field.
	payloadauditlog.DefaultUpstreamModel = payloadauditlogDescUpstreamModel.Default.(string)
	// payloadauditlog.UpstreamModelValidator is a validator for the "upstream_model" field. It is called by the builders before save.
	payloadauditlog.UpstreamModelValidator = payloadauditlogDescUpstreamModel.Validators[0].(func(string) error)
	// payloadauditlogDescStream is the schema descriptor for stream field.
	payloadauditlogDescStream := payloadauditlogFields[12].Descriptor()
	// payloadauditlog.DefaultStream holds the default value on creation for the stream field.
	payloadauditlog.DefaultStream = payloadauditlogDescStream.Default.(bool)
	// payloadauditlogDescStatusCode is the schema descriptor for status_code field.
	payloadauditlogDescStatusCode := payloadauditlogFields[13].Descriptor()
	// payloadauditlog.DefaultStatusCode holds the default value on creation for the status_code field.
	payloadauditlog.DefaultStatusCode = payloadauditlogDescStatusCode.Default.(int)
	// payloadauditlogDescDurationMs is the schema descriptor for duration_ms field.
	payloadauditlogDescDurationMs := payloadauditlogFields[14].Descriptor()
	// payloadauditlog.DefaultDurationMs holds the default value on creation for the duration_ms field.
	payloadauditlog.DefaultDurationMs = payloadauditlogDescDurationMs.Default.(int)
	// payloadauditlogDescInputExcerpt is the schema descriptor for input_excerpt field.
	payloadauditlogDescInputExcerpt := payloadauditlogFields[15].Descriptor()
	// payloadauditlog.DefaultInputExcerpt holds the default value on creation for the input_excerpt field.
	payloadauditlog.DefaultInputExcerpt = payloadauditlogDescInputExcerpt.Default.(string)
	// payloadauditlog.InputExcerptValidator is a validator for the "input_excerpt" field. It is called by the builders before save.
	payloadauditlog.InputExcerptValidator = payloadauditlogDescInputExcerpt.Validators[0].(func(string) error)
	// payloadauditlogDescOutputExcerpt is the schema descriptor for output_excerpt field.
	payloadauditlogDescOutputExcerpt := payloadauditlogFields[16].Descriptor()
	// payloadauditlog.DefaultOutputExcerpt holds the default value on creation for the output_excerpt field.
	payloadauditlog.DefaultOutputExcerpt = payloadauditlogDescOutputExcerpt.Default.(string)
	// payloadauditlog.OutputExcerptValidator is a validator for the "output_excerpt" field. It is called by the builders before save.
	payloadauditlog.OutputExcerptValidator = payloadauditlogDescOutputExcerpt.Validators[0].(func(string) error)
	// payloadauditlogDescInputBody is the schema descriptor for input_body field.
	payloadauditlogDescInputBody := payloadauditlogFields[17].Descriptor()
	// payloadauditlog.DefaultInputBody holds the default value on creation for the input_body field.
	payloadauditlog.DefaultInputBody = payloadauditlogDescInputBody.Default.(string)
	// payloadauditlogDescOutputBody is the schema descriptor for output_body field.
	payloadauditlogDescOutputBody := payloadauditlogFields[18].Descriptor()
	// payloadauditlog.DefaultOutputBody holds the default value on creation for the output_body field.
	payloadauditlog.DefaultOutputBody = payloadauditlogDescOutputBody.Default.(string)
	// payloadauditlogDescInputFormat is the schema descriptor for input_format field.
	payloadauditlogDescInputFormat := payloadauditlogFields[19].Descriptor()
	// payloadauditlog.DefaultInputFormat holds the default value on creation for the input_format field.
	payloadauditlog.DefaultInputFormat = payloadauditlogDescInputFormat.Default.(string)
	// payloadauditlog.InputFormatValidator is a validator for the "input_format" field. It is called by the builders before save.
	payloadauditlog.InputFormatValidator = payloadauditlogDescInputFormat.Validators[0].(func(string) error)
	// payloadauditlogDescOutputFormat is the schema descriptor for output_format field.
	payloadauditlogDescOutputFormat := payloadauditlogFields[20].Descriptor()
	// payloadauditlog.DefaultOutputFormat holds the default value on creation for the output_format field.
	payloadauditlog.DefaultOutputFormat = payloadauditlogDescOutputFormat.Default.(string)
	// payloadauditlog.OutputFormatValidator is a validator for the "output_format" field. It is called by the builders before save.
	payloadauditlog.OutputFormatValidator = payloadauditlogDescOutputFormat.Validators[0].(func(string) error)
	// payloadauditlogDescInputBytes is the schema descriptor for input_bytes field.
	payloadauditlogDescInputBytes := payloadauditlogFields[21].Descriptor()
	// payloadauditlog.DefaultInputBytes holds the default value on creation for the input_bytes field.
	payloadauditlog.DefaultInputBytes = payloadauditlogDescInputBytes.Default.(int)
	// payloadauditlogDescOutputBytes is the schema descriptor for output_bytes field.
	payloadauditlogDescOutputBytes := payloadauditlogFields[22].Descriptor()
	// payloadauditlog.DefaultOutputBytes holds the default value on creation for the output_bytes field.
	payloadauditlog.DefaultOutputBytes = payloadauditlogDescOutputBytes.Default.(int)
	// payloadauditlogDescInputTruncated is the schema descriptor for input_truncated field.
	payloadauditlogDescInputTruncated := payloadauditlogFields[23].Descriptor()
	// payloadauditlog.DefaultInputTruncated holds the default value on creation for the input_truncated field.
	payloadauditlog.DefaultInputTruncated = payloadauditlogDescInputTruncated.Default.(bool)
	// payloadauditlogDescOutputTruncated is the schema descriptor for output_truncated field.
	payloadauditlogDescOutputTruncated := payloadauditlogFields[24].Descriptor()
	// payloadauditlog.DefaultOutputTruncated holds the default value on creation for the output_truncated field.
	payloadauditlog.DefaultOutputTruncated = payloadauditlogDescOutputTruncated.Default.(bool)
	// payloadauditlogDescOutputOmitted is the schema descriptor for output_omitted field.
	payloadauditlogDescOutputOmitted := payloadauditlogFields[25].Descriptor()
	// payloadauditlog.DefaultOutputOmitted holds the default value on creation for the output_omitted field.
	payloadauditlog.DefaultOutputOmitted = payloadauditlogDescOutputOmitted.Default.(bool)
	// payloadauditlogDescErrorMessage is the schema descriptor for error_message field.
	payloadauditlogDescErrorMessage := payloadauditlogFields[26].Descriptor()
	// payloadauditlog.DefaultErrorMessage holds the default value on creation for the error_message field.
	payloadauditlog.DefaultErrorMessage = payloadauditlogDescErrorMessage.Default.(string)
