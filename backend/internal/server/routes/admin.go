...
func registerUserManagementRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	users := admin.Group("/users")
	{
		...
		users.POST("/:id/reset-rate-limits", h.Admin.User.ResetRateLimits)
...
func registerPayloadAuditRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	audit := admin.Group("/payload-audit")
	{
		...
		audit.POST("/payloads/:id/conversation/export", h.AuditConversation.StartConversationExport)
		audit.GET("/conversation-exports/:job_id", h.AuditConversation.GetConversationExportStatus)
		audit.GET("/conversation-exports/:job_id/result", h.AuditConversation.GetConversationExportResult)
