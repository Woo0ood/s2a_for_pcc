...
func ProvideAdminHandlers(
	...
	payloadAuditHandler *admin.PayloadAuditAdminHandler,
	...
	return &AdminHandlers{
		...
		PayloadAudit:           payloadAuditHandler,
...
func ProvideGatewayHandler(
	...
	h := NewGatewayHandler(gatewayService, openAIGatewayService, geminiCompatService, antigravityGatewayService,
		...
		errorPassthroughService, contentModerationService, userMsgQueueService, cfg, settingService, payloadAuditSvc, payloadAuditSink)
...
func ProvideOpenAIGatewayHandler(
	...
	h := NewOpenAIGatewayHandler(gatewayService, concurrencyService, billingCacheService, apiKeyService,
		usageRecordWorkerPool, errorPassthroughService, contentModerationService, payloadAuditSvc, payloadAuditSink,
		settingService, opsService, cfg)
	h.securityAuditCoordinator = coordinator
...
func ProvideHandlers(
	...
	auditConversationHandler *AuditConversationHandler,
...
var ProviderSet = wire.NewSet(
	...
	NewAuditConversationHandler,
	ProvideAuditConversationRepo,
