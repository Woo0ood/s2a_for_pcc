...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/Woo0ood/s2a_for_pcc/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="Woo0ood/s2a_for_pcc"
...
Documentation=https://github.com/Woo0ood/s2a_for_pcc
