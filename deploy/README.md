...
curl -sSL https://raw.githubusercontent.com/Woo0ood/s2a_for_pcc/main/deploy/docker-deploy.sh -o docker-deploy.sh
...
1. Download the latest release from [GitHub Releases](https://github.com/Woo0ood/s2a_for_pcc/releases)
