  ...
  admin: {
    ...
    users: {
      ...
      form: {
        ...
        rateLimitPlaceholder: '0 表示不限制',
        rateLimit5hHint: '该用户在滚动 5 小时窗口内累计可消耗的最大金额，跨所有 API Key 聚合；0 = 不限制',
        rateLimit7dHint: '该用户在滚动 7 天窗口内累计可消耗的最大金额，跨所有 API Key 聚合；0 = 不限制',
        currentUsage5h: '当前 5h 已用: {usage} USD，重置时间: {reset}',
        currentUsage7d: '当前 7d 已用: {usage} USD，重置时间: {reset}',
        resetRateLimits: '复位限额用量',
        resetRateLimitsHint: '将当前 5h/7d 的已用金额清零，并重置窗口起点',
        resetRateLimitsConfirm: '确定要复位该用户的 5h/7d 限额用量吗？此操作会立即解除限流。',
        resetRateLimitsSuccess: '已复位限额用量',
        resetRateLimitsFailed: '复位失败',
        resetting: '复位中...'
      },
      adjustBalance: '调整余额',
